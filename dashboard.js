...
function openProductModal(productId = null) {
  // Similar implementation to article modal
  showNotification("Product modal functionality would be implemented here", "info")
}
...
function addUser(event) {
  ...
  // Pastikan usersData sudah didefinisikan di atas
  const newUser = {
